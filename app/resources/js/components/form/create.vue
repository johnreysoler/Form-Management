...
import container from '../../crafted/form/container/container.vue';
            ...
            <div class="row mt-2 h-100">
                <div class="col h-100" style="max-height:90vh;overflow-y:scroll">
                    <container :Component="component" v-for="(component, index) in form.componentCollection"
                        ...
                        @SectionProperty="getSectionProperties" @RemoveComponent="getRemoveComponent" :FormDetails="props.form"
                        :FormCollection="form.dataCollection"></container>
                </div>
                <div class="col-1">
