    ...
    <div class="p-3">
        <div class="container-body">
            <QuestionComponent :Component="props.Component" @QuestionProperty="getSectionProperty"
                class="container-content" v-if="props.Component.name === 'question'"></QuestionComponent>
            <ImageComponent :Component="props.Component" @ImageProperty="getSectionProperty" class="container-content"
                v-else-if="props.Component.name === 'image'"></ImageComponent>
            <TextComponent :Component="props.Component" @TextProperty="getSectionProperty" class="container-content"
        ...
        <div class="container-footer ">
            <div class="footer-container">
                <div class="footer-content">
                    <div class="row px-3">
                        <div class="col" >
                            <Prerequisite :Component="props.Component" 
                            :FormDetails="props.FormDetails" 
                            :FormCollection="props.FormCollection"
                            @PrerequisiteCollection="PrerequisiteCollection" 
                            :key="props.Component.id"></Prerequisite>
                        </div>
                        <div class="border-end d-flex" :class="section.multipleselectoptiontype ? 'col-3' : 'col justify-content-end'" v-if="props.Component.requiredswitch">
